...
namespace PopBalloons.Utilities
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public void Home()
        {
            ...
            // Return MainPanel to mode selection screen ONLY if we were playing a game
            if (wasPlaying && PopBalloons.UI.MainPanel.Instance != null)
            {
                PopBalloons.UI.MainPanel.Instance.SetState(PopBalloons.UI.MainPanelState.MODE_PICK);
            }
